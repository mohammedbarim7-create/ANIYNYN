...
def verify_developer_file():
    ...
    with open(dev_file, 'r') as f:
        content = f.read()
        if "AnonyxMod" not in content or "Anony" not in content:
...
bot = telebot.TeleBot(config['8551495843:AAGu3CDEEPKHKAP5JUVLUroRF59_MaNvh5Q'])
admin_id = [str(config['6150696594'])]
...
def welcome_start(message):
    ...
    welcome_text = (
        ...
        f"━━━━━━━━━━━━━━━━━━━━━\n"
        f"𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗧𝗼 𝗔𝗡𝗢𝗡𝗬 𝗗𝗗𝗢𝗦 {message.from_user.first_name}!\n\n"
        f"🎯 /bgmi : Start Attack\n"
...
def show_plan_list(message):
    ...
    plan_message = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        "💳 <b>𝐅𝐨𝐫 𝐏𝐮𝐫𝐜𝐡𝐚𝐬𝐞 𝐂𝐨𝐧𝐭𝐚𝐜𝐭:</b> @AnonyxMod\n"
...
def handle_bgmi(message):
    ...
    if user_id not in allowed_user_ids:
        bot.reply_to(message, "🚫 <b>𝗬𝗼𝘂 𝗗𝗼𝗻'𝘁 𝗛𝗮𝘃𝗲 𝗔𝗻𝘆 𝗔𝗰𝘁𝗶𝘃𝗲 𝗣𝗹𝗮𝗻 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 @AnonyxMod</b>", parse_mode="HTML")
        return
    ...
    if current_active_attacks >= MAX_SLOTS:
        bot.reply_to(message, (
            ...
            f"⏳ 𝗣𝗹𝗲𝗮𝘀𝗲 𝘄𝗮𝗶𝘁 𝗳𝗼𝗿 𝗮𝘁𝘁𝗮𝗰𝗸𝘀 𝘁𝗼 𝗲𝗻𝗱."
        ), parse_mode="HTML")
        return
    ...
    if user_id in admin_id:
        ...
        if len(command) > 1:
            ...
            formatted_msg = (
                ...
                f"📝 {text_to_broadcast}\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━\n"
                "🚀 <b>𝐏𝐨𝐰𝐞𝐫:</b> <b>𝗔𝗡𝗢𝗡𝗬 𝗗𝗗𝗢𝗦 𝗣𝗢𝗪𝗘𝗥 🔥</b>"
            )
...
print(f"DRX Master Bot Active... Owner: {AnønyxMod}")
